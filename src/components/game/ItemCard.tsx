 ...
 * gold cost. Hovers lift with a scanline shimmer; selected locks a gold edge.
 */
    ...
    >
      ...
      <div
        style={{
          ...
          fontSize: '28px',
          background:
            'radial-gradient(circle at 50% 40%, var(--gold-glow-15), transparent 70%)',
      ...
      <div style={{ position: 'relative', flex: 1, minWidth: 0 }}>
        ...
        >
          <div
            style={{
              ...
              fontWeight: 'var(--weight-semi)' as unknown as number,
          ...
          <Badge tone="solid" shape="pill" style={{ flex: '0 0 auto' }}>
            ◈ {cost}
          </Badge>
        </div>
        ...
        >
          ...
          {attack != null && <span style={readout}>⚔ {attack}</span>}
          {cooldown != null && <span style={readout}>◔ {cooldown.toFixed(1)}s</span>}
        </div>
